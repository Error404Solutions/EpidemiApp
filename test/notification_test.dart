  ...
  test('Verificar que el título de la notificación se maneje correctamente',
    ...
    final RemoteMessage message = RemoteMessage(
      ...
      notification: const RemoteNotification(
        ...
        body:
            'Bebe muchos líquidos (agua, sueros orales, jugos naturales) para prevenir la deshidratación.',
        android: AndroidNotification(
          imageUrl:
              'https://tukuz.com/wp-content/uploads/2020/12/medtech-global-logo-vector.png',
        ),
